...
const WEAPON_NAMES = {
  ...
  'S-LOGIC-01': '树状图分析术',
  'S-LOGIC-02': '逻辑判断术',
  'S-LOGIC-03': '赋值法与通项锁定术',
  'S-ANALYTIC-01': '直线方程',
  'S-ANALYTIC-02': '圆的方程',
  'S-ANALYTIC-03': '解析几何综合',
  'S-ANALYTIC-04': '圆锥曲线综合',
  'S-COMB-01': '奇偶构造/周期分组',
  'S-COMB-02': '待定系数/倒数构造',
  'S-COMB-03': '裂项放缩/阿贝尔变换',
  'S-COMB-04': '有序枚举与经典模型识别',
  'S-COMPLEX-01': '几何模型术',
  'S-CONIC-01': '定义降维与第三定义',
  'S-CONIC-02': '焦点三角形面积公式',
  'S-CONIC-03': '渐近线几何性质与距离公式',
  'S-CONIC-04': '几何不等式构造与边界分析',
  'S-CONIC-07': '参数方程',
  'S-CONIC-08': '阿波罗尼斯圆性质',
  'S-DER-06': '导数与不等式',
  'S-DER-07': '导数与方程',
